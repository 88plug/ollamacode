...
for (const [os, arch] of targets) {
  ...
  await $`bun build --define OPENCODE_VERSION="'${version}'" --compile --minify-syntax --target=bun-${os}-${arch} --outfile=dist/${name}/bin/opencode ./src/index.ts ./dist/${name}/bin/tui`
